...
function Get-ConfigSettingValue
{
    ...
    if(-NOT $settingValue)
    {
        Log-Message "$settingName setting is not defined in Environment."
        $settingValue = $defaultSettingValue
    }
    
    Log-Message "Setting value: $settingValue"
    return $settingValue.Trim('/')
}

function Download-TofinoAgentComponents
{   
    #Download all the APM Agent pieces

	 Log-Message "Start - Tofino agent download process."
    [string[]]$tofinoInstallerComponentFiles = "MicrosoftMonitoringAgentExtensionLauncher.exe", "MicrosoftMonitoringAgentExtensionLauncher.exe.config"
    
	$tofinoAgentStoreLocation = Get-ConfigSettingValue "Microsoft.AppInsights.ApmAgentLocation" "https://eusamtrddata1.blob.core.windows.net/prod-downloads-7a265556-be49-427e-8c37-0b2a6fadeb03/2014-0/"

    $tofinoInstallerComponentFiles | ForEach {
        Retry {
            $tofinoComponentUrl = $tofinoAgentStoreLocation + "/" + $_
            Log-Message "Downloading from $tofinoComponentUrl"

            $wc = New-Object System.Net.WebClient
            $componentFilePath = ""

            $componentFilePath = Join-Path $RootDir $_
            
            $wc.DownloadFile($tofinoComponentUrl, $componentFilePath)

            Log-Message "Downloaded from $tofinoComponentUrl successfully"
        }
    }

    Log-Message "End - Tofino agent download process."
}

function Install-TofinoAgentComponents
{
    $tofinoMsiLocalPath = Join-Path $RootDir "MicrosoftMonitoringAgentExtensionLauncher.exe"

    if(Test-Path($tofinoMsiLocalPath))
    {
        iex "$tofinoMsiLocalPath emulateAzureExtension";
    }
}

Log-Message "Start of Tofino Agent installation"

Download-TofinoAgentComponents

Install-TofinoAgentComponents

Log-Message "End of Tofino Agent installation"

# SIG # Begin signature block
# MIIawwYJKoZIhvcNAQcCoIIatDCCGrACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUfyTttc1xt6AMkC/x3NEb35se
# GPmgghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# AAEAAACwMAkGBSsOAwIaBQCggcQwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQw
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFHul
# TDgMttHsoBxfz0Heyfxs5odZMGQGCisGAQQBgjcCAQwxVjBUoDaANABNAGkAYwBy
# AG8AcwBvAGYAdAAgAE0AbwBuAGkAdABvAHIAaQBuAGcAIABBAGcAZQBuAHShGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBACazt4Xv
# k5F0euypuxz2huuY1xnw5/c23Hweb7QHwXFnYOzT2yLAqe5uTGyjALxBDfSHvGi+
# uNiMdXJU/OyDAWgp75+ekpkba590TGmT03MLjB5n5SD2b7fjTD2Qn56TO7aAVz8C
# ZMhDG4ZgUiwz5wwWxaff9x458O/YNGWmFBVcYZkx13ms3nS6VAvakua7hs2yBQjK
# cn4EYp8lj7mX4iYGGWcQPfEETPvQpOohN470NmO+y9/j8BNEJM84kES4s5jt/feq
# DxrdO8S+ytZmSsTbJlBq7XlDghU49TnjmemLuScdvgCSAH5ECQsEQX4l5D0QT/Bk
# DHUK/DzGMC+u1ZOhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzEL
# MAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1v
# bmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3JhdGlvbjEhMB8GA1UEAxMYTWlj
# cm9zb2Z0IFRpbWUtU3RhbXAgUENBAhMzAAAATKHoTcy0dHs7AAAAAABMMAkGBSsO
# AwIaBQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEP
# Fw0xNDAzMjYyMjMzMjhaMCMGCSqGSIb3DQEJBDEWBBRfOiPecccO5dYuf2L8UVOO
# qC8aHDANBgkqhkiG9w0BAQUFAASCAQCrnR8F69CBig2JV0/7vWAZ/yhv3LpXw1Q6
# OwRnLHv7/nEeGNdvfKn2lTPQq478hxO28GNMkEyCH76Avk09BEW7h4L2XZJBcU5/
# vmd7I+tMTsZI/S8Yl8OfklAyPOwr5b62DmYN8K+q6BD7qpMca9PQkLg3+R9eRAQX
# R9YAk8J+D7JmjC9wORjT61euSTTVTshnHS+LkatxhTS0VKECfXeR/ZZnc3pfKuPn
# seM8GboSdQ2/tlmcv2/sH3dAV6RbAprvJkhXRcrBj0Xj2a32tzsZaT0jSVV5pK8j
# j++bb6M3t8DTppD9m1gVIo8u1kTYb9u4fgVuRo+Sw091CmCyhFkV
